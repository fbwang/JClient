(function() {
    ...
    J.Qk(function(b) {
        ...
        c.prototype.tj = function() {
            if (null != this.Xb) {
                for (var b = this.Xb, c = 0; c < b.length; ++c)
                    b[c].call(),
                    b[c] = null;
                this.Xb = null
            }
        ...
        c.race = function(b) {
            return new c(function(c, d) {
                for (var f = J.Pg(b), g = f.next(); !g.done; g = f.next())
                    e(g.value).ic(c, d)
            }
            )
        }
    ...
    K.nd = function(b, c, d) {
        ...
        for (var e; b.length && (e = b.shift()); )
            !b.length && K.P(c) ? d[e] = c : d = d[e] && d[e] !== Object.prototype[e] ? d[e] : d[e] = {}
    }
    ;
    ...
    ,
    K.uj = function() {
        if (K.P(K.global.Ae) && K.L(K.global.Ae))
            K.Ka = K.global.Ae;
        else if (K.og()) {
            var b = K.global.document;
    ...
    ,
    K.$h = !(K.global.atob || !K.global.document || !K.global.document.all),
    K.Zg = !1,
    K.Yj = function(b, c, d) {
    ...
    K.Ql = function(b, c) {
        if (K.og()) {
            ...
            void 0 === c ? K.$h ? (K.Zg = !0,
            c = " onreadystatechange='goog.onScriptLoad_(this, " + ++K.Ng + ")' ",
            d.write(n + b + '"' + c + ">\x3c/script>")) : K.Fe ? K.Hi(b) : K.Pl(b) : d.write('<script type="text/javascript">' + K.Rk(c) + "\x3c/script>");
            return !0
        }
        return !1
    }
    ...
    K.Kt = function(b, c) {
        ...
        if (!e) {
            ...
            if (g) {
                eval(g + a + f);
                if (K.global.$gwtExport && K.global.$gwtExport.$jscomp && !K.global.$gwtExport.$jscomp.transpile)
                    throw Error('The transpiler did not properly export the "transpile" method. $gwtExport: ' + JSON.stringify(K.global.$gwtExport));
    ...
    K.aa = function(b) {
        ...
        if (c == y)
            if (b) {
                ...
                if ("[object Window]" == d)
                    return y;
                if ("[object Array]" == d || typeof b.length == x && "undefined" != typeof b.splice && "undefined" != typeof b.propertyIsEnumerable && !b.propertyIsEnumerable("splice"))
                    return r;
                if ("[object Function]" == d || "undefined" != typeof b.call && "undefined" != typeof b.propertyIsEnumerable && !b.propertyIsEnumerable("call"))
                    return u
            } else
                return "null";
        else if (c == u && "undefined" == typeof b.call)
            return y;
        return c
    }
    ;
    ...
    ;
    K.Qj = function(b) {
        if (K.global.execScript)
            K.global.execScript(b, "JavaScript");
        else if (K.global.eval) {
            if (null == K.oc)
                if (K.global.eval("var _evalTest_ = 1;"),
    ...
    K.pa.bf = function(b, c) {
        ...
        for (var e = 0; e < K.pa.Oe.length; e++)
            d = K.pa.Oe[e],
            Object.prototype.hasOwnProperty.call(c, d) && (b[d] = c[d])
    }
    ;
    ...
    K.f.Yg = function(b, c, d) {
        ...
        for (var e = b.toLowerCase().match(d), f = c.toLowerCase().match(d), g = Math.min(e.length, f.length), h = 0; h < g; h++) {
            ...
            if (d != l)
                ...
                !isNaN(b) && (c = parseInt(l, 10),
                !isNaN(c) && b - c) ? b - c : d < l ? -1 : 1
        }
    ...
    K.f.ua = function(b, c) {
        if (c)
            b = b.replace(K.f.me, "&amp;").replace(K.f.Le, "&lt;").replace(K.f.Ie, "&gt;").replace(K.f.Se, "&quot;").replace(K.f.Ue, "&#39;").replace(K.f.Ne, "&#0;"),
            K.f.Xc && (b = b.replace(K.f.Ge, "&#101;"));
        else {
            if (!K.f.Bh.test(b))
                return b;
            -1 != b.indexOf("&") && (b = b.replace(K.f.me, "&amp;"));
            -1 != b.indexOf("<") && (b = b.replace(K.f.Le, "&lt;"));
            -1 != b.indexOf(">") && (b = b.replace(K.f.Ie, "&gt;"));
            -1 != b.indexOf('"') && (b = b.replace(K.f.Se, "&quot;"));
            -1 != b.indexOf("'") && (b = b.replace(K.f.Ue, "&#39;"));
            -1 != b.indexOf("\x00") && (b = b.replace(K.f.Ne, "&#0;"));
    ...
    ;
    K.f.H.s = function(b) {
        if (b instanceof K.f.H && b.constructor === K.f.H && b.ui === K.f.H.Xe)
            return b.Lc;
    ...
    K.j.Lb = function(b, c, d) {
        if (!K.Qb(b) || !K.Qb(c) || b.length != c.length)
            return !1;
        var e = b.length;
        d = d || K.j.ij;
        for (var f = 0; f < e; f++)
    ...
    K.h.i = {};
    K.h.i.Wh = !1;
    K.h.i.Ke = K.h.i.Wh || ("ar" == K.ba.substring(0, 2).toLowerCase() || "fa" == K.ba.substring(0, 2).toLowerCase() || "he" == K.ba.substring(0, 2).toLowerCase() || "iw" == K.ba.substring(0, 2).toLowerCase() || "ps" == K.ba.substring(0, 2).toLowerCase() || "sd" == K.ba.substring(0, 2).toLowerCase() || "ug" == K.ba.substring(0, 2).toLowerCase() || "ur" == K.ba.substring(0, 2).toLowerCase() || "yi" == K.ba.substring(0, 2).toLowerCase()) && (2 == K.ba.length || "-" == K.ba.substring(2, 3) || "_" == K.ba.substring(2, 3)) || 3 <= K.ba.length && "ckb" == K.ba.substring(0, 3).toLowerCase() && (3 == K.ba.length || "-" == K.ba.substring(3, 4) || "_" == K.ba.substring(3, 4));
    K.h.i.nb = {
        ci: "\u202a",
        fi: "\u202b",
        Qe: "\u202c",
    ...
    K.h.i.xf = function(b, c) {
        ...
        for (c = 0; c < b.length; c++) {
            var g = b[c];
            K.h.i.mh(g) ? (d++,
            e++) : K.h.i.Hg.test(g) ? f = !0 : K.h.i.mg(g) ? e++ : K.h.i.Uj.test(g) && (f = !0)
        }
    ...
    K.h.i.at = function(b, c) {
        b && (c = K.h.i.xl(c)) && (b.style.textAlign = c == K.h.i.O.Wa ? K.h.i.ec : K.h.i.cc,
        b.dir = c == K.h.i.O.Wa ? "rtl" : "ltr")
    }
    ;
    ...
    K.b.D.s = function(b) {
        if (b instanceof K.b.D && b.constructor === K.b.D && b.xi === K.b.D.ca)
            return b.Ec;
    ...
    ;
    K.b.D.Xh = /%{(\w+)}/g;
    K.b.D.Fh = /^(?:file:)?.\/[0-9a-z.:[\]-]+\/|^\/[^\/\\]|^about:blank(#|$)/i;
    K.b.D.pc = function(b) {
    ...
    K.debug.Z.hs = function(b) {
        K.debug.Z.Vg = !0;
        for (var c = K.bind(b.Ol, b), d = 0; d < K.debug.Z.Bb.length; d++)
            K.debug.Z.Bb[d](c);
        K.debug.Z.Vd.push(b)
    }
    ;
    K.debug.Z.Qt = function(b) {
        var c = K.debug.Z.Vd;
        b = K.bind(b.s, b);
        for (var d = 0; d < K.debug.Z.Bb.length; d++)
            K.debug.Z.Bb[d](b);
        c.length--
    }
    ;
    ...
    K.object.cr = function(b, c) {
        for (var d = K.Qb(c), e = d ? c : arguments, d = d ? 0 : 1; d < e.length && (b = b[e[d]],
        K.P(b)); d++)
            ;
        return b
    }
    ...
    K.object.extend = function(b, c) {
        for (var d, e, f = 1; f < arguments.length; f++) {
            ...
            for (d in e)
                b[d] = e[d];
            for (var g = 0; g < K.object.Re.length; g++)
                d = K.object.Re[g],
    ...
    K.object.dj = function(b) {
        var c = arguments.length;
        if (1 == c && K.isArray(arguments[0]))
            return K.object.dj.apply(null, arguments[0]);
        for (var d = {}, e = 0; e < c; e++)
            d[arguments[e]] = !0;
        return d
    }
    ...
    K.g.userAgent.v.Ob = function() {
        ...
        if (K.g.userAgent.v.xc())
            return K.g.userAgent.v.Gj(c);
    ...
    K.g.userAgent.U.Ob = function() {
        ...
        if (b) {
            ...
            if (c)
                return "Gecko" == c[0] ? K.g.userAgent.U.Oj(b) : c[1];
            var b = b[0], d;
    ...
    K.async.ra = function(b, c, d) {
        ...
        c && (e = K.bind(b, c));
        e = K.async.ra.xh(e);
        K.ya(K.global.setImmediate) && (d || K.async.ra.Hl()) ? K.global.setImmediate(e) : (K.async.ra.jh || (K.async.ra.jh = K.async.ra.Kj()),
        K.async.ra.jh(e))
    }
    ;
    ...
    K.async.Da.prototype.remove = function() {
        var b = null;
        this.Fb && (b = this.Fb,
        this.Fb = this.Fb.next,
        this.Fb || (this.Rc = null),
        b.next = null);
        return b
    }
    ;
    ...
    K.g.userAgent.platform.Ob = function() {
        var b = K.g.userAgent.A.wb();
        var c = "";
        K.g.userAgent.platform.Mg() ? (c = /Windows (?:NT|Phone) ([0-9.]+)/,
        c = (b = c.exec(b)) ? b[1] : "0.0") : K.g.userAgent.platform.Cg() ? (c = /(?:iPhone|iPod|iPad|CPU)\s+OS\s+(\S+)/,
        c = (b = c.exec(b)) && b[1].replace(/_/g, ".")) : K.g.userAgent.platform.Gg() ? (c = /Mac OS X ([0-9_.]+)/,
        c = (b = c.exec(b)) ? b[1].replace(/_/g, ".") : "10") : K.g.userAgent.platform.wg() ? (c = /Android\s+([^\);]+)(\)|;)/,
        c = (b = c.exec(b)) && b[1]) : K.g.userAgent.platform.yg() && (c = /(?:CrOS\s+(?:i686|x86_64)\s+([0-9.]+))/,
        c = (b = c.exec(b)) && b[1]);
        return c || ""
    }
    ;
    ...
    K.userAgent.lj = function() {
        var b = ""
          , c = K.userAgent.Pj();
        c && (b = c ? c[1] : "");
        return K.userAgent.Y && (c = K.userAgent.Mf(),
    ...
    K.b.V.s = function(b) {
        if (b instanceof K.b.V && b.constructor === K.b.V && b.ji === K.b.V.ca)
            return b.Bc;
    ...
    K.b.F.s = function(b) {
        if (b instanceof K.b.F && b.constructor === K.b.F && b.li === K.b.F.ca)
            return b.Dc;
    ...
    K.b.F.create = function(b) {
        ...
        for (d in b) {
            ...
            var e = b[d];
            null != e && (e instanceof K.f.H ? e = K.f.H.s(e) : K.b.F.Bi.test(e) ? K.b.F.Sj(e) || (K.m.la("String value requires balanced quotes, got: " + e),
            e = K.b.F.Ua) : (K.m.la("String value allows only [-,.\"'%_!# a-zA-Z0-9] and simple functions, got: " + e),
            e = K.b.F.Ua),
            c += d + ":" + e + ";")
        }
    ...
    K.b.M.Rj = function(b) {
        for (var c = {
            ...
            if (c[f])
                d.push(c[f]);
            else if (K.object.contains(c, f) && d.pop() != f)
                return !1
        }
        return 0 == d.length
    }
    ...
    K.b.M.s = function(b) {
        if (b instanceof K.b.M && b.constructor === K.b.M && b.ki === K.b.M.ca)
            return b.Cc;
    ...
    K.b.u.s = function(b) {
        if (b instanceof K.b.u && b.constructor === K.b.u && b.ni === K.b.u.ca)
            return b.Ga;
    ...
    K.b.l.s = function(b) {
        if (b instanceof K.b.l && b.constructor === K.b.l && b.ii === K.b.l.ca)
            return b.Ga;
    ...
    K.b.l.zj = function(b, c, d) {
        if (d instanceof K.f.H)
            ...
            if (c.toLowerCase()in K.b.l.zi)
                if (d instanceof K.b.D)
                    d = K.b.D.s(d);
                else if (d instanceof K.b.u)
                    d = K.b.u.s(d);
                else if (K.L(d))
                    d = K.b.u.Sa(d).qa();
                else
    ...
    K.b.l.concat = function(b) {
        function c(b) {
            K.isArray(b) ? K.j.forEach(b, c) : (b = K.b.l.ua(b),
            e += K.b.l.s(b),
            b = b.bb(),
            d == K.h.i.O.sa ? d = b : b != K.h.i.O.sa && d != b && (d = null))
        }
        var d = K.h.i.O.sa
          , e = "";
        K.j.forEach(arguments, c);
    ...
    K.b.l.$a = function(b, c, d) {
        ...
        K.a.Nc.pk(b.toLowerCase()) ? f += ">" : (e = K.b.l.concat(d),
        f += ">" + K.b.l.s(e) + "</" + b + ">",
        e = e.bb());
    ...
    K.a.S.kh = function(b, c) {
        if (K.m.na && K.a.S.ri[b.tagName.toUpperCase()])
    ...
    K.o.bs = function(b, c, d, e) {
        ...
        for (var q = [], l = f, m = g; 0 < l && 0 < m; )
            d(b[l - 1], c[m - 1]) ? (q.unshift(e(l - 1, m - 1)),
            l--,
            m--) : h[l - 1][m] > h[l][m - 1] ? l-- : m--;
        return q
    }
    ;
    K.o.ge = function(b) {
    ...
    K.a.qc = function(b, c, d, e) {
        ...
        if (d) {
            ...
            for (g = c = 0; h = e[g]; g++)
                f = h.className,
                typeof f.split == u && K.j.contains(f.split(/\s+/), d) && (b[c++] = h);
            b.length = c;
            return b
        }
        return e
    ...
    K.a.eh = function(b, c) {
        var d = K.a.Na(b, "DIV");
        K.a.jb.Zh ? (K.a.S.kh(d, K.b.l.concat(K.b.l.ye, c)),
        d.removeChild(d.firstChild)) : K.a.S.kh(d, c);
        return K.a.Xi(b, d)
    }
    ;
    K.a.Xi = function(b, c) {
    ...
    K.a.cg = function(b) {
        var c;
        if (K.a.jb.Kh && !(K.userAgent.Y && K.userAgent.va("9") && !K.userAgent.va("10") && K.global.SVGElement && b instanceof K.global.SVGElement) && (c = b.parentElement))
            return c;
        c = b.parentNode;
    ...
    K.a.lf = function(b, c) {
        ...
        if (K.userAgent.Y && !K.userAgent.Sb(9)) {
            if (b.nodeType == K.a.fa.Yc)
                return -1;
            if (c.nodeType == K.a.fa.Yc)
                return 1
        }
        if ("sourceIndex"in b || b.parentNode && "sourceIndex"in b.parentNode) {
            ...
            var f = b.parentNode
              , g = c.parentNode;
            return f == g ? K.a.nf(b, c) : !d && K.a.contains(f, c) ? -1 * K.a.mf(b, c) : !e && K.a.contains(g, b) ? K.a.mf(c, b) : (d ? b.sourceIndex : f.sourceIndex) - (e ? c.sourceIndex : g.sourceIndex)
        }
        e = K.a.Pa(b);
        d = e.createRange();
        d.selectNode(b);
    ...
    K.a.ng = function(b) {
        ...
        K.fb(b) && b.specified) : b.hasAttribute("tabindex")
    }
    ;
    K.a.Jg = function(b) {
        b = b.tabIndex;
    ...
    ;
    K.a.sc = function(b) {
        if (K.a.jb.ze && null !== b && "innerText"in b)
            b = K.f.Vi(b.innerText);
        else {
            var c = [];
            K.a.Bd(b, c, !0);
            b = c.join("")
    ...
    K.a.Bd = function(b, c, d) {
        if (!(b.nodeName in K.a.Ve))
            if (b.nodeType == K.a.fa.fc)
                d ? c.push(String(b.nodeValue).replace(/(\r\n|\r|\n)/g, "")) : c.push(b.nodeValue);
            else if (b.nodeName in K.a.dc)
                c.push(K.a.dc[b.nodeName]);
            else
                for (b = b.firstChild; b; )
                    K.a.Bd(b, c, d),
                    b = b.nextSibling
    ...
    K.a.Zf = function(b, c, d) {
        ...
        for (var e = 0, f = null; 0 < b.length && e < c; )
            if (f = b.pop(),
            !(f.nodeName in K.a.Ve))
                if (f.nodeType == K.a.fa.fc)
                    var g = f.nodeValue.replace(/(\r\n|\r|\n)/g, "").replace(/ +/g, " ")
                      , e = e + g.length;
                else if (f.nodeName in K.a.dc)
                    e += K.a.dc[f.nodeName].length;
                else
                    for (g = f.childNodes.length - 1; 0 <= g; g--)
                        b.push(f.childNodes[g]);
        K.ha(d) && (d.Ds = f ? f.nodeValue.length + c - e - 1 : 0,
        d.node = f);
        return f
    }
    ;
    K.a.Nd = function(b) {
        if (b && typeof b.length == x) {
            if (K.ha(b))
                return typeof b.item == u || typeof b.item == B;
            if (K.ya(b))
                return typeof b.item == u
        }
        return !1
    }
    ;
    ...
    K.Promise = function(b, c) {
        ...
        K.Promise.Aa && (this.ee = [],
        N(this, Error("created")),
        this.uf = 0);
        if (b != K.Ra)
            try {
                var d = this;
                b.call(c, function(b) {
                    ...
                    if (K.ea && !(b instanceof K.Promise.lb))
                        try {
        ...
        return new K.Promise(function(c) {
            ...
            if (d)
                for (var f = function(b, f, g) {
                    ...
                    h = b[g],
                    K.Promise.Hc(h, K.gb(f, g, !0), K.gb(f, g, !1));
            else
                c(e)
        }
        )
    ...
    function P(b, c) {
        if (b.$ == K.Promise.R.wa)
            if (b.da) {
                var d = b.da;
                if (d.Ma) {
                    for (var e = 0, f = null, g = null, h = d.Ma; h && (h.gc || (e++,
                    h.Za == b && (f = h),
                    !(f && 1 < e))); h = h.next)
                        f || (g = h);
                    f && (d.$ == K.Promise.R.wa && 1 == e ? P(d, c) : (g ? (e = g,
                    e.next == d.qb && (d.qb = e),
                    e.next = e.next.next) : Q(d),
                    R(d, f, K.Promise.R.ja, c)))
                }
                b.da = null
            } else
                O(b, K.Promise.R.ja, c)
    }
    function S(b, c) {
    ...
    ;
    function O(b, c, d) {
        b.$ == K.Promise.R.wa && (b === d && (c = K.Promise.R.ja,
        d = new TypeError("Promise cannot resolve to itself")),
        b.$ = K.Promise.R.Gh,
        K.Promise.Tg(d, b.Al, b.Bl, b) || (b.ia = d,
        b.$ = c,
        b.da = null,
        T(b),
        c != K.Promise.R.ja || d instanceof K.Promise.lb || K.Promise.Fi(b, d)))
    }
    K.Promise.Tg = function(b, c, d, e) {
        if (b instanceof K.Promise)
            return K.Promise.Aa && N(b, Error("then")),
            S(b, K.Promise.Jf(c || K.Ra, d || null, e)),
            !0;
        if (K.Thenable.Bg(b))
            return b.then(c, d, e),
            !0;
    ...
    K.Promise.prototype.sj = function() {
        for (var b; b = Q(this); )
            K.Promise.Aa && this.uf++,
            R(this, b, this.$, this.ia);
        this.md = !1
    }
    ;
    function R(b, c, d, e) {
    ...
    K.Promise.Fi = function(b, c) {
        ...
        }, K.Promise.Ya) : 0 == K.Promise.Ya && (b.uc = !0,
        K.async.N(function() {
            b.uc && (U(b, c),
            K.Promise.vc.call(null, c))
        }))
...
*/
    K.async.w = function(b, c) {
        ...
        this.da = null;
        this.hc = 0;
        K.async.w.Aa && (this.fd = null,
        Error.captureStackTrace && (b = {
            stack: ""
        },
        Error.captureStackTrace(b, K.async.w),
        typeof b.stack == B && (this.fd = b.stack.replace(/^[^\n]*\n/, ""))))
    }
    ;
    K.async.w.si = !1;
    K.async.w.Aa = !1;
    ...
    I.cancel = function(b) {
        if (this.ub)
            this.ia instanceof K.async.w && this.ia.cancel();
        else {
            if (this.da) {
                var c = this.da;
                delete this.da;
    ...
    function W(b) {
        b.Oc && b.ub && fa(b) && (K.async.w.Fl(b.Oc),
        b.Oc = 0);
        b.da && (b.da.hc--,
        delete b.da);
        for (var c = b.ia, d = !1, e = !1; b.Jc.length && !b.cd; ) {
            ...
            if (g = b.yb ? h : g)
                try {
                    ...
                    K.P(l) && (b.yb = b.yb && (l == c || l instanceof Error),
                    b.ia = c = l);
                    if (K.Thenable.Bg(c) || typeof K.global.Promise === u && c instanceof K.global.Promise)
                        e = !0,
                        b.cd = !0
                } catch (m) {
                    c = m,
        ...
        e ? (e = K.bind(b.qf, b, !0),
        l = K.bind(b.qf, b, !1),
        c instanceof K.async.w ? (Z(c, e, l),
        c.Qi = !0) : c.then(e, l)) : K.async.w.si && c instanceof Error && !(c instanceof K.async.w.kb) && (d = b.yb = !0);
    ...
    K.async.w.Fl = function(b) {
        ...
        c && (K.global.clearTimeout(c.Pb),
        delete K.async.w.Mb[b])
    }
    ;
    K.async.w.zp = function() {
        var b = K.async.w.Mb, c;
        for (c in b) {
            var d = b[c];
    ...
    K.B.C.Yb = function(b, c) {
        ...
        f.onload = f.onreadystatechange = function() {
            f.readyState && "loaded" != f.readyState && f.readyState != t || (K.B.C.jc(f, d.Tp || !1, l),
            h.Ib(null))
        }
        ;
        f.onerror = function() {
    ...
    K.B.C.el = function(b, c, d) {
        ...
        var e = K.global[K.B.C.$c]
          , f = K.b.D.s(b);
        if (K.P(e[c]))
            return K.async.w.la(new K.B.C.Error(K.B.C.ac.Di,"Verification object " + c + " already defined."));
        b = K.B.C.Yb(b, d);
        var g = new K.async.w(K.bind(b.cancel, b));
        Y(b, function() {
            var b = e[c];
            K.P(b) ? (g.Ib(b),
            delete e[c]) : g.ab(new K.B.C.Error(K.B.C.ac.Ci,"Script " + f + " loaded, but verification object " + c + " was not defined."))
        });
        ea(b, function(b) {
            K.P(e[c]) && delete e[c];
            g.ab(b)
    ...
    google.G.K.T.Ik = function(b) {
        var c, d = b, e = b.match(/^testing-/);
        e && (d = d.replace(/^testing-/, ""));
        b = d;
        do
            (c = google.G.K.T.Kl[d]) && (d = c);
        while (c);c = (e ? "testing-" : "") + d;
        return {
            version: d == z ? b : c,
            Bk: c
        }
    ...
    google.G.K.T.zk = function(b) {
        var c = google.G.K.T.Ik(b)
          , d = K.f.H.from("file:./chart/45.1/loader.js");
