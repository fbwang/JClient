(function() {
    ...
    R.im = function(b, c) {
        if (R.Dg()) {
            ...
            void 0 === c ? R.ri ? (c = " onreadystatechange='goog.onScriptLoad_(this, " + ++R.ah + ")' ",
            d.write(n + b + '"' + c + ">\x3c/script>")) : R.Se ? R.bj(b) : R.hm(b) : d.write('<script type="text/javascript">' + R.jl(c) + "\x3c/script>");
            return !0
        }
        return !1
    }
    ...
    R.Z = function(b) {
        ...
        if (c == E)
            if (b) {
                ...
                return "null";
        else if (c == z && "undefined" == typeof b.call)
            return E;
        return c
    }
    ;
    ...
    R.hk = function(b) {
        if (R.global.execScript)
            ...
            if (null == R.uc)
                if (R.global.eval("var _evalTest_ = 1;"),
                "undefined" != typeof R.global._evalTest_) {
                    try {
    ...
    R.f.xa = function(b, c) {
        if (c)
            b = b.replace(R.f.Ae, "&amp;").replace(R.f.Ze, "&lt;").replace(R.f.We, "&gt;").replace(R.f.gf, "&quot;").replace(R.f.jf, "&#39;").replace(R.f.bf, "&#0;"),
            R.f.fd && (b = b.replace(R.f.Te, "&#101;"));
        else {
            if (!R.f.Rh.test(b))
                return b;
            ...
            -1 != b.indexOf("\x00") && (b = b.replace(R.f.bf, "&#0;"));
    ...
    R.h.i.Mf = function(b, c) {
        ...
        for (c = 0; c < b.length; c++) {
            var g = b[c];
            R.h.i.Ah(g) ? (d++,
            e++) : R.h.i.Vg.test(g) ? f = !0 : R.h.i.Bg(g) ? e++ : R.h.i.kk.test(g) && (f = !0)
        }
    ...
    R.h.i.Dt = function(b, c) {
        b && (c = R.h.i.Tl(c)) && (b.style.textAlign = c == R.h.i.O.cb ? R.h.i.mc : R.h.i.kc,
        b.dir = c == R.h.i.O.cb ? "rtl" : "ltr")
    }
    ;
    ...
    R.object.Ar = function(b, c) {
        for (var d = R.Yb(c), e = d ? c : arguments, d = d ? 0 : 1; d < e.length && (b = b[e[d]],
        R.P(b)); d++)
            ;
        return b
    }
    ...
    google.l.m.Na = {
        ql: {
            gstatic: {
                ...
                compiled: R.f.H.from("file:./chart/%{version}/js/jsapi_compiled_%{package}_module.js"),
                compiled_i18n: R.f.H.from("https://www.gstatic.com/charts/%{version}/i18n/jsapi_compiled_i18n_%{package}_module__%{language}.js"),
                css: R.f.H.from("file:./chart/%{version}/css/%{subdir}/%{filename}"),
    ...
    google.l.m.Pa.Hf = function(b) {
        ...
        "undefined" !== typeof p.addEventListener ? (p.addEventListener("load", c, !1),
        p.addEventListener("error", d, !1)) : "undefined" !== typeof p.attachEvent && p.attachEvent("onload", function() {
            var b, e = document.styleSheets.length;
            try {
                for (; e--; )
                    if (b = document.styleSheets[e],
                    b.id === l) {
                        c();
                        return
                    }
    ...
    R.b.I.create = function(b) {
        ...
        for (d in b) {
            ...
            var e = b[d];
            null != e && (e instanceof R.f.H ? e = R.f.H.v(e) : R.b.I.Wi.test(e) ? R.b.I.ik(e) || (R.u.ia("String value requires balanced quotes, got: " + e),
            e = R.b.I.Za) : (R.u.ia("String value allows only [-,.\"'%_!# a-zA-Z0-9], rgb() and rgba(), got: " + e),
            e = R.b.I.Za),
            c += d + ":" + e + ";")
        }
    ...
    R.b.o.concat = function(b) {
        function c(b) {
            R.isArray(b) ? R.j.forEach(b, c) : (b = R.b.o.xa(b),
            e += R.b.o.v(b),
            b = b.jb(),
            d == R.h.i.O.ua ? d = b : b != R.h.i.O.ua && d != b && (d = null))
        }
        var d = R.h.i.O.ua
          , e = "";
        R.j.forEach(arguments, c);
    ...
    R.b.o.hb = function(b, c, d) {
        ...
        R.a.Vc.Ik(b.toLowerCase()) ? f += ">" : (e = R.b.o.concat(d),
        f += ">" + R.b.o.v(e) + "</" + b + ">",
        e = e.jb());
    ...
    R.s.Cs = function(b, c, d, e) {
        ...
        for (var p = [], l = f, m = g; 0 < l && 0 < m; )
            d(b[l - 1], c[m - 1]) ? (p.unshift(e(l - 1, m - 1)),
            l--,
    ...
    R.g.userAgent.platform.Wb = function() {
        var b = R.g.userAgent.C.Cb()
          , c = "";
        R.g.userAgent.platform.$g() ? (c = /Windows (?:NT|Phone) ([0-9.]+)/,
        c = (b = c.exec(b)) ? b[1] : "0.0") : R.g.userAgent.platform.Qg() ? (c = /(?:iPhone|iPod|iPad|CPU)\s+OS\s+(\S+)/,
        c = (b = c.exec(b)) && b[1].replace(/_/g, ".")) : R.g.userAgent.platform.Ug() ? (c = /Mac OS X ([0-9_.]+)/,
        c = (b = c.exec(b)) ? b[1].replace(/_/g, ".") : "10") : R.g.userAgent.platform.Kg() ? (c = /Android\s+([^\);]+)(\)|;)/,
        c = (b = c.exec(b)) && b[1]) : R.g.userAgent.platform.Mg() && (c = /(?:CrOS\s+(?:i686|x86_64)\s+([0-9.]+))/,
        c = (b = c.exec(b)) && b[1]);
        return c || ""
    }
    ;
    ...
    R.userAgent.Hj = function() {
        var b = ""
          , c = R.userAgent.gk();
        c && (b = c ? c[1] : "");
        return R.userAgent.W && (c = R.userAgent.$f(),
    ...
    R.a.wc = function(b, c, d, e) {
        ...
        if (d) {
            ...
            for (g = f = 0; h = b[g]; g++)
                c = h.className,
                typeof c.split == z && R.j.contains(c.split(/\s+/), d) && (e[f++] = h);
            e.length = f;
            return e
        }
        return b
    ...
    R.a.rh = function(b, c) {
        var d = R.a.Sa(b, "DIV");
        R.a.sb.pi ? (R.a.M.yh(d, R.b.o.concat(R.b.o.Me, c)),
        d.removeChild(d.firstChild)) : R.a.M.yh(d, c);
        return R.a.pj(b, d)
    }
    ;
    R.a.pj = function(b, c) {
    ...
    R.a.zf = function(b, c) {
        ...
        if ("sourceIndex"in b || b.parentNode && "sourceIndex"in b.parentNode) {
            ...
            var f = b.parentNode
              , g = c.parentNode;
            return f == g ? R.a.Bf(b, c) : !d && R.a.contains(f, c) ? -1 * R.a.Af(b, c) : !e && R.a.contains(g, b) ? R.a.Af(c, b) : (d ? b.sourceIndex : f.sourceIndex) - (e ? c.sourceIndex : g.sourceIndex)
        }
        e = R.a.Ua(b);
        d = e.createRange();
        d.selectNode(b);
    ...
    ;
    R.a.Cg = function(b) {
        return R.userAgent.W && !R.userAgent.ya("9") ? (b = b.getAttributeNode("tabindex"),
        R.mb(b) && b.specified) : b.hasAttribute("tabindex")
    }
    ;
    R.a.Xg = function(b) {
        b = b.tabIndex;
    ...
    R.a.ng = function(b, c, d) {
        ...
        R.la(d) && (d.bt = f ? f.nodeValue.length + c - e - 1 : 0,
        d.node = f);
        return f
    }
    ;
    ...
    R.async.jc.prototype.get = function() {
        ...
        b = this.Bc,
        this.Bc = b.next,
        b.next = null) : b = this.yj();
        return b
    }
    ;
    R.async.jc.prototype.put = function(b) {
        this.ul(b);
        this.Ic < this.Lk && (this.Ic++,
        b.next = this.Bc,
        this.Bc = b)
    }
    ;
    ...
    R.async.ra = function(b, c, d) {
        ...
        c && (e = R.bind(b, c));
        e = R.async.ra.Nh(e);
        R.Aa(R.global.setImmediate) && (d || R.async.ra.cm()) ? R.global.setImmediate(e) : (R.async.ra.xh || (R.async.ra.xh = R.async.ra.ck()),
        R.async.ra.xh(e))
    }
    ;
    ...
    R.Promise = function(b, c) {
        ...
        R.Promise.Da && (this.se = [],
        U(this, Error("created")),
        this.Jf = 0);
        if (b != R.Wa)
            try {
                var d = this;
        ...
        return new R.Promise(function(c) {
            ...
            if (d)
                for (var f = function(b, f, g) {
                    ...
                    h = b[g],
                    R.Promise.Pc(h, R.ob(f, g, !0), R.ob(f, g, !1));
            else
                c(e)
        }
        )
    ...
    R.Promise.Du = function() {
        var b, c, d = new R.Promise(function(d, f) {
            b = d;
            c = f
        }
        );
    ...
    function W(b, c) {
        if (b.sa == R.Promise.S.bb)
            if (b.ba) {
                var d = b.ba;
                if (d.Ra) {
                    for (var e = 0, f = null, g = null, h = d.Ra; h && (h.oc || (e++,
                    h.gb == b && (f = h),
                    !(f && 1 < e))); h = h.next)
                        f || (g = h);
                    f && (d.sa == R.Promise.S.bb && 1 == e ? W(d, c) : (g ? (e = g,
                    e.next == d.yb && (d.yb = e),
                    e.next = e.next.next) : ca(d),
                    da(d, f, R.Promise.S.za, c)))
                }
                b.ba = null
            } else
    ...
    ;
    function V(b, c, d) {
        b.sa == R.Promise.S.bb && (b === d && (c = R.Promise.S.za,
        d = new TypeError("Promise cannot resolve to itself")),
        b.sa = R.Promise.S.Vh,
        R.Promise.gh(d, b.Wl, b.Xl, b) || (b.Ba = d,
        b.sa = c,
        b.ba = null,
        fa(b),
        c != R.Promise.S.za || d instanceof R.Promise.ub || R.Promise.$i(b, d)))
    }
    R.Promise.gh = function(b, c, d, e) {
        if (b instanceof R.Promise)
            return R.Promise.Da && U(b, Error("then")),
            ea(b, R.Promise.Xf(c || R.Wa, d || null, e)),
            !0;
        if (R.Thenable.Pg(b))
            return b.then(c, d, e),
            !0;
    ...
    R.Promise.prototype.Nj = function() {
        for (var b; b = ca(this); )
            R.Promise.Da && this.Jf++,
            da(this, b, this.sa, this.Ba);
        this.td = !1
    }
    ;
    function da(b, c, d, e) {
    ...
    R.Promise.$i = function(b, c) {
        ...
        }, R.Promise.fb) : 0 == R.Promise.fb && (b.zc = !0,
        R.async.N(function() {
            b.zc && (ga(b, c),
            R.Promise.Ac.call(null, c))
        }))
...
*/
    R.async.B = function(b, c) {
        ...
        this.ba = null;
        this.pc = 0;
        R.async.B.Da && (this.od = null,
        Error.captureStackTrace && (b = {
            stack: ""
        },
        Error.captureStackTrace(b, R.async.B),
        typeof b.stack == H && (this.od = b.stack.replace(/^[^\n]*\n/, ""))))
    }
    ;
    R.async.B.Oi = !1;
    R.async.B.Da = !1;
    ...
    Q.then = function(b, c, d) {
        var e, f, g = new R.Promise(function(b, c) {
            e = b;
            f = c
        }
        );
    ...
    function ha(b) {
        b.Wc && b.Bb && la(b) && (R.async.B.bm(b.Wc),
        b.Wc = 0);
        b.ba && (b.ba.pc--,
        delete b.ba);
        for (var c = b.Ba, d = !1, e = !1; b.Rc.length && !b.ld; ) {
            ...
            if (g = b.Eb ? h : g)
                try {
                    ...
                    R.P(l) && (b.Eb = b.Eb && (l == c || l instanceof Error),
                    b.Ba = c = l);
        ...
        e ? (e = R.bind(b.Ef, b, !0),
        l = R.bind(b.Ef, b, !1),
        c instanceof R.async.B ? (Z(c, e, l),
        c.hj = !0) : c.then(e, l)) : R.async.B.Oi && c instanceof Error && !(c instanceof R.async.B.tb) && (d = b.Eb = !0);
    ...
    R.async.B.bm = function(b) {
        ...
        c && (R.global.clearTimeout(c.Xb),
        delete R.async.B.Ub[b])
    }
    ;
    R.async.B.Rp = function() {
        var b = R.async.B.Ub, c;
        for (c in b) {
            var d = b[c];
    ...
    R.D.F.fc = function(b, c) {
        ...
        f.onload = f.onreadystatechange = function() {
            f.readyState && "loaded" != f.readyState && f.readyState != w || (R.D.F.qc(f, d.kq || !1, h),
            g.Pb(null))
        }
        ;
        f.onerror = function() {
    ...
    R.D.F.El = function(b, c, d) {
        ...
        Y(b, function() {
            var b = e[c];
            R.P(b) ? (g.Pb(b),
            delete e[c]) : g.ib(new R.D.F.Error(R.D.F.ic.Xi,"Script " + f + " loaded, but verification object " + c + " was not defined."))
        });
        ka(b, function(b) {
            R.P(e[c]) && delete e[c];
            g.ib(b)
    ...
    google.l.m.fl = function(b) {
        ...
        google.l.m.Na.Dh[b] ? (b = google.l.m.Na.Dh[b],
        R.object.extend(c, b),
        b = google.l.m.qb[b.subdir ? "third_party" : "third_party2"]) : google.l.m.Na.Ch[b] ? (R.object.extend(c, google.l.m.Na.Ch[b]),
        b = google.l.m.qb.third_party_gen) : b = google.l.m.qb[(google.l.m.Pd ? "debug" : google.l.m.Xd ? "pseudo" : "compiled") + (google.l.m.Gc ? "_i18n" : "")];
        return b ? {
            format: b,
            tf: c
        } : null
    ...
    google.l.m.bh = function(b) {
        ...
        b.subdir2 && (c = google.l.m.qb.css2,
        d.subdir1 = b.subdir1,
        d.subdir2 = b.subdir2);
        return {
            format: c,
    ...
    google.l.m.il = function(b, c) {
        ...
        R.Ja("google.visualization.isDebug", d);
    ...
    google.l.m.me = function(b) {
        ...
        google.l.m.cc || (google.l.m.log("onload and not loading"),
        google.l.m.ce())
    }
    ;
